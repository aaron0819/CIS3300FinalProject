...
BOARDWIDTH = 8 # width of board
BOARDHEIGHT = 8 # height of board
GEMIMAGESIZE = 64 # pixel size of each block

# NUMGEMIMAGES is the number of gem types. 
NUMGEMIMAGES = 7
assert NUMGEMIMAGES >= 5 # game needs at least 5 types of gems to play

# NUMMATCHSOUNDS is the number of different sounds to choose from when
# a match is made. 
NUMMATCHSOUNDS = 6

MOVERATE = 25 # 1 to 100, high number means faster animations
...
BGCOLOR = LIGHTBLUE # background color of the screen
...
EMPTY_SPACE = -1 # an arbitrary, nonpositive value to represent empty blocks
